<template>
  <q-layout style="font-family: Times New Roman; font-size: 10px;" v-if="outfit" id="outfit-print">
    ...
    <div class="page">
        ...
        <table class="col-8 tables" border="1" cellspacing="0">
          <thead>
            <tr>
              ...
              <th rowspan="3" width="15%">Параграф<br />справ.<br />норм</th>
              <th rowspan="3" width="5%">Вып-ено<br />норм</th>
              <th rowspan="3">Расценка,<br />руб.</th>
              <th rowspan="3">Сумма,<br />руб.</th>
              <th colspan="3">Отработано</th>
            </tr>
            <tr>
              <th>Нормы<br/>выраб</th>
              <th>Выпол<br/>нено</th>
              <th width="5%">Чел- <br />дней</th>
              <th width="5">Маш.<br />смен</th>
      ...
      <div class="row flex-center q-mt-md" style="outline: 1px solid;">
        <div class="col-6">
          <div class="row q-pa-sm">Наряд выдан:&nbsp;
            <span class="text-center pos relative-position q-mr-sm bor-bot" style="min-width: 100px;">
              {{ outfit.issued.position }}
            </span>
